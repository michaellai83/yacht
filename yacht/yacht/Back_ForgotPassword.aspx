<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Back_ForgotPassword.aspx.cs" Inherits="yacht.Back_ForgotPassword" %>
                                    ...
                                    <div class="text-center">
                                     ...
                                     <form id="form1" runat="server" class="user">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <asp:Button ID="Button_ResetPassword" runat="server" Text="Reset Password"  class="btn btn-primary btn-user btn-block" OnClick="Button_ResetPassword_Click" />
                                        
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="Back_AdminAdd.aspx">Create an Account!</a>
                                    </div>
                                    <div class="text-center">
