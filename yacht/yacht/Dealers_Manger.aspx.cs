...
namespace yacht
{
    public partial class Dealers_Manger : System.Web.UI.Page
    {
        ...
        protected void Country_sub_Click(object sender, EventArgs e)
        {
            ...
            if (city != "" && saletype != "" && contact != "" && add != "" && tel != "" && email != "")
            {
                if(fax != "")
                {
                    ...
                    connection.Close();
                    Response.Write($"<script>alert('已新增資料');;location.href='Dealers_Manger.aspx';</script>");
                }
                else
                {
                    SqlConnection connection = new SqlConnection(SqlName);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            command.ExecuteNonQuery();
            connect.Close();
            Response.Write($"<script>alert('已刪除國家');;location.href='Dealers_Manger.aspx';</script>");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                command.ExecuteNonQuery();
                connection.Close();
                Response.Write($"<script>alert('已增加國家');;location.href='Dealers_Manger.aspx';</script>");
                //Response.Redirect("Dealers_Manger.aspx");
            }
        }
        ...
        {
            Response.Redirect("Dealers_Mangeraddbase.aspx");
        }
    }
}