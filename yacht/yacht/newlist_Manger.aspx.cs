...
namespace yacht
{
    public partial class newlist : System.Web.UI.Page
    {
        ...
        protected void title_btn_Click(object sender, EventArgs e)
        {
            ...
            //    string sql = $"INSERT INTO News(title, FileName,FilePath) VALUES (@title, @FileName,@FilePath)";
            ...
            //    connection.Close();
            //    Response.Write($"<script>alert('已新增資料');;location.href='newlist_Manger.aspx';</script>");
            ...
            string title = Textitle.Text.Trim();
            string main = Textmain.Text.Trim();
            ...
            if (title != "")
            {
                ...
                FileUpload2.SaveAs(filePathName);
                string sql = $"INSERT INTO NewsTest01(title, main, havepic, initdate, titleFileName,titleFilePath) VALUES (@title, @main, @havepic, @initdate, @titleFileName,@titleFilePath)";
                SqlCommand command = new SqlCommand(sql, connection);
                connection.Open();
        ...
        protected void upload_Click(object sender, EventArgs e)
        {
            ...
            //string sql = @"INSERT INTO News_pic(Newsid,FileName,FilePath) Values(@ID,@FileName,@FilePath)";
            //SqlCommand command = new SqlCommand(sql, connection);
