<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Back/Back_Login.aspx.cs" Inherits="yacht.Back_Login" %>
...
<body class="bg-gradient-primary">
    ...
    <asp:TextBox class="form-control form-control-user"
                                        ...
                                        <div class="form-group">
        <asp:TextBox class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Password" runat="server" TextMode="Password"></asp:TextBox>
                                           
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <asp:CheckBox runat="server"  id="customCheck" Text="Remember Me" />
